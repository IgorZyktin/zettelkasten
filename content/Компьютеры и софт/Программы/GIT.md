...
1. [Узнать изменения в коммите](#Узнать-изменения-в-коммите)
...
### Узнать изменения в коммите

По сути мы хотим разницу между коммитом и его родителем.

```shell
git diff <commit>~ <commit>
```

Если нужны изменения только в самом последнем коммите:
